  ...
  return (
    <div className="flex flex-col items-center mt-6 lg:mt-20">
      <h1 className="text-4xl sm:text-6xl lg:text-7xl text-center tracking-wide">
        Innovate beyond imagination <br />
      ...
      <p className="mt-10 text-lg text-center text-neutral-500 max-w-4xl">
        "Empower your creativity and shape the future of AI. Build intelligent
        solutions, push boundaries, and turn visionary ideas into groundbreaking
        technology—innovate beyond imagination!"
      </p>
